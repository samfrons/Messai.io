...
export default function Safe3DModel({ designName, className = '' }: Safe3DModelProps) {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const geometry = getDesignGeometry(designName);
      const material = new THREE.MeshPhongMaterial({ 
        color: getDesignColor(designName),
        emissive: getDesignColor(designName),
  ...
  function getDesignGeometry(name: string): THREE.BufferGeometry {
