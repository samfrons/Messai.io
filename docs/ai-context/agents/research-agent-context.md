# Research Agent Context - MESSAI Clean Architecture
...
/packages/@messai/core/src/types/              # Research data models and interfaces
/apps/web/app/api/papers/                      # Literature API endpoints
/apps/web/lib/database-utils.ts                # Research data validation patterns
```

### Clean Architecture Context
```
/packages/@messai/core/                        # Core business logic for research
/packages/@messai/ui/                          # Shared research UI components
/apps/web/                                     # Main MESSAI web application
/scripts/literature/                           # Literature processing automation
```
...
*This context template is specifically designed for Research Agents working on MESSAI's scientific literature management using clean architecture principles. It ensures scientific accuracy while maintaining integration with the broader MESSAI research platform. Last updated: July 2025*