  ...
  (_a, ref) => {
    ...
    return /* @__PURE__ */ jsxs(
      ...
      __spreadProps(__spreadValues({
        ...
        children: [
          loading && /* @__PURE__ */ jsx("span", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxs(
            "svg",
            {
...
var CardContent = React2.forwardRef((_a, ref) => {
  var _b = _a, { className } = _b, props = __objRest(_b, ["className"]);
  return /* @__PURE__ */ jsx("div", __spreadValues({ ref, className: cn("text-gray-700 dark:text-gray-300", className) }, props));
});
  ...
  (_a, ref) => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "w-full", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative", children: [
        icon && iconPosition === "left" && /* @__PURE__ */ jsx("div", { className: "absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none", children: /* @__PURE__ */ jsx("span", { className: "text-gray-500 dark:text-gray-400 sm:text-sm", children: icon }) }),
        /* @__PURE__ */ jsx(
          "input",
          __spreadValues({
            ref,
        ...
        icon && iconPosition === "right" && /* @__PURE__ */ jsx("div", { className: "absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none", children: /* @__PURE__ */ jsx("span", { className: "text-gray-500 dark:text-gray-400 sm:text-sm", children: icon }) })
      ] }),
      error && /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-red-600 dark:text-red-400", id: "error-message", children: error }),
      hint && !error && /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-gray-500 dark:text-gray-400", id: "hint-message", children: hint })
    ] });
  }
);
...
function MESSModel3D({
  ...
  const loadModel = useCallback(async (THREE, scene) => {
  ...
  if (!webglSupported) {
    return /* @__PURE__ */ jsx("div", { className: `flex items-center justify-center h-full bg-gray-900 rounded-lg p-8 ${className}`, children: /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsx("p", { className: "text-red-500 mb-2", children: "WebGL is not supported on your device" }),
      /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-400", children: "Please use a modern browser with WebGL support to view 3D models." })
    ] }) });
  }
  if (error) {
    return /* @__PURE__ */ jsx("div", { className: `flex items-center justify-center h-full bg-gray-900 rounded-lg p-8 ${className}`, children: /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsx("p", { className: "text-red-500 mb-2", children: "Failed to load 3D model" }),
      /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-400", children: error.message })
    ] }) });
  }
  return /* @__PURE__ */ jsxs("div", { className: `relative w-full h-full bg-gray-900 rounded-lg overflow-hidden ${className}`, children: [
    /* @__PURE__ */ jsx("div", { ref: mountRef, className: "w-full h-full" }),
    isLoading && /* @__PURE__ */ jsx("div", { className: "absolute inset-0 flex items-center justify-center bg-gray-900 bg-opacity-90", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center", children: [
      /* @__PURE__ */ jsx("div", { className: "w-12 h-12 border-4 border-primary-500 border-t-transparent rounded-full animate-spin mb-4" }),
      /* @__PURE__ */ jsx("p", { className: "text-gray-400", children: "Loading 3D model..." })
    ] }) }),
    process.env.NODE_ENV === "development" && performanceRef.current && /* @__PURE__ */ jsxs("div", { className: "absolute top-2 left-2 bg-black bg-opacity-50 px-2 py-1 rounded text-xs text-white", children: [
      "FPS: ",
...
function MESSModel3DLite({
  ...
  const getDesignElement = () => {
    ...
    switch (design) {
      case "earthen-pot":
        return /* @__PURE__ */ jsxs("div", { className: "relative w-32 h-32", style: baseStyle, children: [
          /* @__PURE__ */ jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsx("div", { className: "absolute inset-4 bg-gray-900 rounded-full opacity-50" })
        ] });
      case "mason-jar":
        return /* @__PURE__ */ jsxs("div", { className: "relative w-24 h-32", style: baseStyle, children: [
          /* @__PURE__ */ jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsx("div", { className: "absolute top-0 inset-x-0 h-4 bg-gray-400 rounded-t-lg" }),
          /* @__PURE__ */ jsx("div", { className: "absolute bottom-4 inset-x-2 h-16 bg-yellow-700 opacity-30 rounded" })
        ] });
      case "micro-chip":
        return /* @__PURE__ */ jsxs("div", { className: "relative w-20 h-20", style: baseStyle, children: [
          /* @__PURE__ */ jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsx("div", { className: "absolute inset-2 bg-gray-700 rounded", children: /* @__PURE__ */ jsx("div", { className: "absolute inset-1 bg-green-400 rounded animate-pulse" }) })
        ] });
      case "3d-printed":
        return /* @__PURE__ */ jsx("div", { className: "relative w-28 h-28", style: baseStyle, children: /* @__PURE__ */ jsx(
          "div",
          {
      ...
      case "wetland":
        return /* @__PURE__ */ jsxs("div", { className: "relative w-36 h-20", style: baseStyle, children: [
          /* @__PURE__ */ jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsx("div", { className: "absolute bottom-8 left-4 w-2 h-12 bg-green-600 rounded-t-full" }),
          /* @__PURE__ */ jsx("div", { className: "absolute bottom-8 left-8 w-2 h-10 bg-green-600 rounded-t-full" }),
          /* @__PURE__ */ jsx("div", { className: "absolute bottom-8 right-4 w-2 h-14 bg-green-600 rounded-t-full" }),
          /* @__PURE__ */ jsx("div", { className: "absolute bottom-8 right-8 w-2 h-11 bg-green-600 rounded-t-full" })
        ] });
      default:
        return /* @__PURE__ */ jsx("div", { className: "relative w-24 h-24", style: baseStyle, children: /* @__PURE__ */ jsx(
          "div",
          {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `flex items-center justify-center h-full ${className}`, style: { perspective: "1000px" }, children: [
    /* @__PURE__ */ jsxs("div", { className: "text-xs text-red-500 absolute top-1 right-1 z-10", children: [
      "3D: ",
      design
    ] }),
    getDesignElement()
...
export { Button, Card, CardContent, CardHeader, CardTitle, Input, MESSModel3D, MESSModel3DLite, Textarea, checkWebGLSupport, cn };
